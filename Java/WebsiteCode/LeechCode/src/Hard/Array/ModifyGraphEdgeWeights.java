    ...
    public static void main(String[] args) {
        ...
        for (int[][][] test : tests) {
            int n = test[0][0][0],
                edges[][] = test[1],
                source = test[2][0][0],
                destination = test[3][0][0],
                target = test[4][0][0];

            System.out.println(new ModifyGraphEdgeWeights_Solution().modifiedGraphEdges(n, edges, source, destination, target));
        }
    }
}

// 250 ms 51.7MB
class ModifyGraphEdgeWeights_Solution {
