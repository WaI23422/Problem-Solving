...
/**
 * <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/maximum-nesting-depth-of-the-parentheses/">1614. Maximum Nesting Depth of the Parentheses</a>
 * 
...
public class MaximumNestingDepthOfTheParentheses {
    public static void main(String[] args) {
        ...
        for (String s : tests) {
            System.out.println(new MaximumNestingDepthOfTheParentheses_Solution().maxDepth(s));
        }
    }
}

// @see Easy.String.MaximumNestingDepthOfTheParentheses.java
class MaximumNestingDepthOfTheParentheses_Solution {
