...
/**
 * <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/minimum-bit-flips-to-convert-number/">2220. Minimum Bit Flips to Convert Number</a>
 * 
...
public class MinimumBitFlipsToConvertNumber {
    public static void main(String[] args) {
        ...
        for (int[] test : tests) {
            ...
            System.out.println(new MinimumBitFlipsToConvertNumber_Solution().minBitFlips(start, end));
        }
    }
}

// 0ms 40.07MB
class MinimumBitFlipsToConvertNumber_Solution {
