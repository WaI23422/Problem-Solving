...
/**
 * <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/is-subsequence/">392. Is Subsequence</a>
 * 
...
public class IsSubsequence {
    public static void main(String[] args) {
        ...
        for (String[] test : tests) {
            ...
            System.out.println(new IsSubsequence_Solution().isSubsequence(s, t));
        }
    }
}
