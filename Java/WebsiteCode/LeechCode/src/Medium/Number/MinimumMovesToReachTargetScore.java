...
/**
 * <a class="no-underline hover:text-blue-s dark:hover:text-dark-blue-s truncate cursor-text whitespace-normal hover:!text-[inherit]" href="/problems/minimum-moves-to-reach-target-score/">2139. Minimum Moves to Reach Target Score</a>
 * 
 * <div class="elfjS" data-track-load="description_content"><p>You are playing a game with integers. You start with the integer <code>1</code> and you want to reach the integer <code>target</code>.</p>
 * 
...
public class MinimumMovesToReachTargetScore {
    public static void main(String[] args) {
        ...
        for (int[] test : tests) {
            ...
            System.out.println(new MinimumMovesToReachTargetScore_Solution().minMoves(target, maxDoubles));
        }
    }
}

// 0ms 40.30MB
class MinimumMovesToReachTargetScore_Solution {
